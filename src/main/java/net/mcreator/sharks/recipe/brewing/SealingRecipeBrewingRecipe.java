...
public class SealingRecipeBrewingRecipe implements IBrewingRecipe {
   ...
   public boolean isIngredient(ItemStack ingredient) {
      return Ingredient.of(new ItemStack[]{new ItemStack((ItemLike)BenssharksModItems.SUCKER.get())}).test(ingredient);
   }

   public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
      return this.isInput(input) && this.isIngredient(ingredient)
         ? PotionContents.createItemStack(input.getItem(), BenssharksModPotions.POTION_OF_SEALING)
         : ItemStack.EMPTY;
   }
}
