...
public class BenssharksModItems {
   ...
   public static final DeferredItem<Item> NURSE_SHARK_SPAWN_EGG = REGISTRY.register(
      "nurse_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.NURSE_SHARK, -7766419, -1580587, new Properties())
   );
   ...
   public static final DeferredItem<Item> REMORA_SPAWN_EGG = REGISTRY.register(
      "remora_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.REMORA, -14210244, -7495501, new Properties())
   );
   ...
   public static final DeferredItem<Item> LAND_MINE = REGISTRY.register(
      BenssharksModBlocks.LAND_MINE.getId().getPath(), () -> new LandMineDisplayItem((Block)BenssharksModBlocks.LAND_MINE.get(), new Properties())
   );
   public static final DeferredItem<Item> TIGER_SHARK_SPAWN_EGG = REGISTRY.register(
      "tiger_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.TIGER_SHARK, -9807546, -3292239, new Properties())
   );
   ...
   public static final DeferredItem<Item> AXODILE_SPAWN_EGG = REGISTRY.register(
      "axodile_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.AXODILE, -12362095, -5395065, new Properties())
   );
   ...
   public static final DeferredItem<Item> BLUE_SHARK_SPAWN_EGG = REGISTRY.register(
      "blue_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BLUE_SHARK, -10905911, -4203544, new Properties())
   );
   public static final DeferredItem<Item> BONNETHEAD_SHARK_SPAWN_EGG = REGISTRY.register(
      "bonnethead_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BONNETHEAD_SHARK, -5921371, -1, new Properties())
   );
   public static final DeferredItem<Item> MAKO_SHARK_SPAWN_EGG = REGISTRY.register(
      "mako_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.MAKO_SHARK, -10389086, -526598, new Properties())
   );
   ...
   public static final DeferredItem<Item> COOKIECUTTER_SHARK_SPAWN_EGG = REGISTRY.register(
      "cookiecutter_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.COOKIECUTTER_SHARK, -10728903, -6322827, new Properties())
   );
   ...
   public static final DeferredItem<Item> BLACKTIP_REEF_SHARK_SPAWN_EGG = REGISTRY.register(
      "blacktip_reef_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BLACKTIP_REEF_SHARK, -7169893, -12828864, new Properties())
   );
   ...
   public static final DeferredItem<Item> BASKING_SHARK_SPAWN_EGG = REGISTRY.register(
      "basking_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BASKING_SHARK, -9738139, -6579302, new Properties())
   );
   public static final DeferredItem<Item> BULL_SHARK_SPAWN_EGG = REGISTRY.register(
      "bull_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BULL_SHARK, -9076581, -2368549, new Properties())
   );
   public static final DeferredItem<Item> SHARK_PLUSH_BLOCK = REGISTRY.register(
      BenssharksModBlocks.SHARK_PLUSH_BLOCK.getId().getPath(),
      () -> new SharkPlushieDisplayItem((Block)BenssharksModBlocks.SHARK_PLUSH_BLOCK.get(), new Properties())
   );
   public static final DeferredItem<Item> MEGALODON_SPAWN_EGG = REGISTRY.register(
      "megalodon_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.MEGALODON, -11775140, -4473928, new Properties())
   );
   public static final DeferredItem<Item> LAND_SHARK_SPAWN_EGG = REGISTRY.register(
      "land_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.LAND_SHARK, -10915167, -6840401, new Properties())
   );
   ...
   public static final DeferredItem<Item> LEMON_SHARK_SPAWN_EGG = REGISTRY.register(
      "lemon_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.LEMON_SHARK, -4151200, -133677, new Properties())
   );
   ...
   public static final DeferredItem<Item> THALASSOGER_SPAWN_EGG = REGISTRY.register(
      "thalassoger_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.THALASSOGER, -6972517, -12820585, new Properties())
   );
   ...
   public static final DeferredItem<Item> KRILL_SPAWN_EGG = REGISTRY.register(
      "krill_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.KRILL, -2195122, -8827080, new Properties())
   );
   ...
   public static final DeferredItem<Item> WHALE_SHARK_SPAWN_EGG = REGISTRY.register(
      "whale_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.WHALE_SHARK, -12762287, -5189411, new Properties())
   );
   public static final DeferredItem<Item> LAND_MINE_PRIMED = REGISTRY.register(
      BenssharksModBlocks.LAND_MINE_PRIMED.getId().getPath(),
      () -> new LandMinePrimedDisplayItem((Block)BenssharksModBlocks.LAND_MINE_PRIMED.get(), new Properties())
   );
   ...
   public static final DeferredItem<Item> PILOT_FISH_SPAWN_EGG = REGISTRY.register(
      "pilot_fish_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.PILOT_FISH, -5322279, -13617608, new Properties())
   );
   ...
   public static final DeferredItem<Item> GREATER_AXODILE_SPAWN_EGG = REGISTRY.register(
      "greater_axodile_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.GREATER_AXODILE, -13408880, -2237997, new Properties())
   );
   ...
   public static final DeferredItem<Item> GREENLAND_SHARK_SPAWN_EGG = REGISTRY.register(
      "greenland_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.GREENLAND_SHARK, -12105914, -9738139, new Properties())
   );
   public static final DeferredItem<Item> WHITETIP_SHARK_SPAWN_EGG = REGISTRY.register(
      "whitetip_shark_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.WHITETIP_SHARK, -9870239, -1579804, new Properties())
   );
   ...
   public static final DeferredItem<Item> BARRACUDA_SPAWN_EGG = REGISTRY.register(
      "barracuda_spawn_egg", () -> new DeferredSpawnEggItem(BenssharksModEntities.BARRACUDA, -4469285, -11962230, new Properties())
   );
