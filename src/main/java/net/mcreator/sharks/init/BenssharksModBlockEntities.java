...
public class BenssharksModBlockEntities {
   ...
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> SHARK_PLUSH_BLOCK = register(
      "shark_plush_block", BenssharksModBlocks.SHARK_PLUSH_BLOCK, SharkPlushieTileEntity::new
   );
   public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> LAND_MINE_PRIMED = register(
      "land_mine_primed", BenssharksModBlocks.LAND_MINE_PRIMED, LandMinePrimedTileEntity::new
   );
