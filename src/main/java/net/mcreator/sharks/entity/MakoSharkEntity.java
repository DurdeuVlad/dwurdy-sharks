...
import net.mcreator.sharks.procedures.MakoSprintProcedure;
...
public class MakoSharkEntity extends PathfinderMob implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (MakoSharkEntity.this.isInWater()) {
               MakoSharkEntity.this.setDeltaMovement(MakoSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !MakoSharkEntity.this.getNavigation().isDone()) {
               ...
               MakoSharkEntity.this.setYRot(this.rotlerp(MakoSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (MakoSharkEntity.this.isInWater()) {
                  ...
                  MakoSharkEntity.this.setXRot(this.rotlerp(MakoSharkEntity.this.getXRot(), f2, 5.0F));
               ...
               MakoSharkEntity.this.setSpeed(0.0F);
               MakoSharkEntity.this.setYya(0.0F);
               MakoSharkEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
         e -> e.getType().is(DwurdySharksEntityTypeTags.MAKO_SHARK_PREY)));
      ...
      this.goalSelector.addGoal(39, new AvoidEntityGoal(this, ShrakEntity.class, 8.0F, 16.0, 16.0));
      this.goalSelector.addGoal(40, new AvoidEntityGoal(this, TigerSharkEntity.class, 8.0F, 16.0, 16.0));
      this.goalSelector.addGoal(41, new AvoidEntityGoal(this, AxodileEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(42, new AvoidEntityGoal(this, Dolphin.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(43, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(44, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(45, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public boolean hurt(DamageSource source, float amount) {
      MakoSharkEntityIsHurtProcedure.execute(this.level(), this);
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      MakoSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }

   public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
      super.awardKillScore(entity, score, damageSource);
      MakoSharkThisEntityKillsAnotherOneProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
   }
   ...
   public static net.minecraft.world.entity.ai.attributes.AttributeSupplier.Builder createAttributes() {
      ...
      return builder.add(NeoForgeMod.SWIM_SPEED, 1.75);
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         if (this.isInWaterOrBubble()) {
            ...
            return !this.onGround() ? event.setAndContinue(RawAnimation.begin().thenLoop("fall")) : event.setAndContinue(RawAnimation.begin().thenLoop("land"));
         }
      } else {
