...
public class WhaleSharkEntity extends PathfinderMob implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (WhaleSharkEntity.this.isInWater()) {
               WhaleSharkEntity.this.setDeltaMovement(WhaleSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !WhaleSharkEntity.this.getNavigation().isDone()) {
               ...
               WhaleSharkEntity.this.setYRot(this.rotlerp(WhaleSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (WhaleSharkEntity.this.isInWater()) {
                  ...
                  WhaleSharkEntity.this.setXRot(this.rotlerp(WhaleSharkEntity.this.getXRot(), f2, 5.0F));
               ...
               WhaleSharkEntity.this.setSpeed(0.0F);
               WhaleSharkEntity.this.setYya(0.0F);
               WhaleSharkEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "whaleshark");
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      WhaleSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
