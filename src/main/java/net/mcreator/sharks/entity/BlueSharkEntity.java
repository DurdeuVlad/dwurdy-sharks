...
public class BlueSharkEntity extends PathfinderMob implements GeoEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(9, new TemptGoal(this, 1.0, Ingredient.of(new ItemLike[]{(ItemLike)BenssharksModItems.FISH_BUCKET.get()}), false));
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BenssharksModEntities.BLUE_SHARK.get(),
