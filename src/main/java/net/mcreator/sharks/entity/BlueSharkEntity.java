...
public class BlueSharkEntity extends PathfinderMob implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (BlueSharkEntity.this.isInWater()) {
               BlueSharkEntity.this.setDeltaMovement(BlueSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !BlueSharkEntity.this.getNavigation().isDone()) {
               ...
               BlueSharkEntity.this.setYRot(this.rotlerp(BlueSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (BlueSharkEntity.this.isInWater()) {
                  ...
                  BlueSharkEntity.this.setXRot(this.rotlerp(BlueSharkEntity.this.getXRot(), f2, 5.0F));
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "blueshark");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Player.class, true, true) {
         ...
         public boolean canContinueToUse() {
            return super.canContinueToUse() && AggressiveSharksProcedureProcedure.execute(BlueSharkEntity.this.level());
         }
      });
      this.goalSelector.addGoal(9, new TemptGoal(this, 1.0, Ingredient.of(new ItemLike[]{(ItemLike)DwurdySharksModItems.FISH_BUCKET.get()}), false));
      this.goalSelector.addGoal(11, new LookAtPlayerGoal(this, WaterAnimal.class, 128.0F));
      this.goalSelector.addGoal(12, new AvoidEntityGoal(this, MegalodonEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(13, new AvoidEntityGoal(this, ElderGuardian.class, 64.0F, 16.0, 16.0));
      this.goalSelector.addGoal(14, new AvoidEntityGoal(this, Guardian.class, 64.0F, 16.0, 16.0));
      this.goalSelector.addGoal(15, new AvoidEntityGoal(this, ShrakEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(16, new AvoidEntityGoal(this, TigerSharkEntity.class, 8.0F, 16.0, 16.0));
      this.goalSelector.addGoal(17, new AvoidEntityGoal(this, MakoSharkEntity.class, 8.0F, 16.0, 16.0));
      this.goalSelector.addGoal(18, new AvoidEntityGoal(this, AxodileEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(19, new AvoidEntityGoal(this, Dolphin.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(20, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(21, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(22, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      BlueSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)DwurdySharksModEntities.BLUE_SHARK.get(),
