...
public class LemonSharkEntity extends Animal implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (LemonSharkEntity.this.isInWater()) {
               LemonSharkEntity.this.setDeltaMovement(LemonSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !LemonSharkEntity.this.getNavigation().isDone()) {
               ...
               LemonSharkEntity.this.setYRot(this.rotlerp(LemonSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (LemonSharkEntity.this.isInWater()) {
                  ...
                  LemonSharkEntity.this.setXRot(this.rotlerp(LemonSharkEntity.this.getXRot(), f2, 5.0F));
               ...
               LemonSharkEntity.this.setSpeed(0.0F);
               LemonSharkEntity.this.setYya(0.0F);
               LemonSharkEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "lemonshark");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(5, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
         e -> e.getType().is(DwurdySharksEntityTypeTags.LEMON_SHARK_PREY)));
      ...
      this.goalSelector.addGoal(16, new LookAtPlayerGoal(this, BonnetheadSharkEntity.class, 32.0F));
      this.goalSelector.addGoal(17, new LookAtPlayerGoal(this, WaterAnimal.class, 32.0F));
      this.goalSelector.addGoal(18, new AvoidEntityGoal(this, Dolphin.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(19, new AvoidEntityGoal(this, ShrakEntity.class, 4.0F, 16.0, 16.0));
      this.goalSelector.addGoal(20, new AvoidEntityGoal(this, TigerSharkEntity.class, 4.0F, 16.0, 16.0));
      this.goalSelector.addGoal(21, new AvoidEntityGoal(this, BullSharkEntity.class, 4.0F, 16.0, 16.0));
      this.goalSelector.addGoal(22, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(23, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(24, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      LemonSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
