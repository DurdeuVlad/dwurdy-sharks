...
public class BlacktipReefSharkEntity extends Animal implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (BlacktipReefSharkEntity.this.isInWater()) {
               BlacktipReefSharkEntity.this.setDeltaMovement(BlacktipReefSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !BlacktipReefSharkEntity.this.getNavigation().isDone()) {
               ...
               BlacktipReefSharkEntity.this.setYRot(this.rotlerp(BlacktipReefSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (BlacktipReefSharkEntity.this.isInWater()) {
                  ...
                  BlacktipReefSharkEntity.this.setXRot(this.rotlerp(BlacktipReefSharkEntity.this.getXRot(), f2, 5.0F));
               ...
               BlacktipReefSharkEntity.this.setSpeed(0.0F);
               BlacktipReefSharkEntity.this.setYya(0.0F);
               BlacktipReefSharkEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "blacktip");
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(8, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
         e -> e.getType().is(DwurdySharksEntityTypeTags.BLACKTIP_REEF_SHARK_PREY)));
      ...
      this.goalSelector.addGoal(22, new LookAtPlayerGoal(this, WaterAnimal.class, 16.0F));
      this.goalSelector.addGoal(23, new AvoidEntityGoal(this, ElderGuardian.class, 64.0F, 16.0, 16.0));
      this.goalSelector.addGoal(24, new AvoidEntityGoal(this, Guardian.class, 64.0F, 16.0, 16.0));
      this.goalSelector.addGoal(25, new AvoidEntityGoal(this, ShrakEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(26, new AvoidEntityGoal(this, TigerSharkEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(27, new AvoidEntityGoal(this, MakoSharkEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(28, new AvoidEntityGoal(this, BullSharkEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(29, new AvoidEntityGoal(this, BlueSharkEntity.class, 8.0F, 16.0, 16.0));
      this.goalSelector.addGoal(30, new AvoidEntityGoal(this, AxodileEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(31, new AvoidEntityGoal(this, Dolphin.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(32, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(33, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(34, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      BlacktipReefSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public EntityDimensions getDefaultDimensions(Pose pose) {
      return super.getDefaultDimensions(pose).scale(0.875F);
   }

   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      BlacktipReefSharkEntity retval = (BlacktipReefSharkEntity)((EntityType)DwurdySharksModEntities.BLACKTIP_REEF_SHARK.get()).create(serverWorld);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)DwurdySharksModEntities.BLACKTIP_REEF_SHARK.get(),
   ...
   public static net.minecraft.world.entity.ai.attributes.AttributeSupplier.Builder createAttributes() {
      ...
      return builder.add(NeoForgeMod.SWIM_SPEED, 1.35);
   }
