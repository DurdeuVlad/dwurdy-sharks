...
public class CookiecutterSharkEntity extends PathfinderMob implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (CookiecutterSharkEntity.this.isInWater()) {
               CookiecutterSharkEntity.this.setDeltaMovement(CookiecutterSharkEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !CookiecutterSharkEntity.this.getNavigation().isDone()) {
               ...
               CookiecutterSharkEntity.this.setYRot(this.rotlerp(CookiecutterSharkEntity.this.getYRot(), f, 10.0F));
               ...
               if (CookiecutterSharkEntity.this.isInWater()) {
                  ...
                  CookiecutterSharkEntity.this.setXRot(this.rotlerp(CookiecutterSharkEntity.this.getXRot(), f2, 5.0F));
               ...
               CookiecutterSharkEntity.this.setSpeed(0.0F);
               CookiecutterSharkEntity.this.setYya(0.0F);
               CookiecutterSharkEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, BlacktipReefSharkEntity.class, true, true));
      this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, BonnetheadSharkEntity.class, true, true));
      this.targetSelector.addGoal(16, new NearestAttackableTargetGoal(this, BarracudaEntity.class, true, true));
      this.targetSelector.addGoal(17, new NearestAttackableTargetGoal(this, GlowSquid.class, true, true));
      this.targetSelector.addGoal(18, new NearestAttackableTargetGoal(this, Squid.class, true, true));
      this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, AxodileEntity.class, true, true));
      this.targetSelector.addGoal(20, new NearestAttackableTargetGoal(this, Turtle.class, true, true));
      this.targetSelector.addGoal(21, new NearestAttackableTargetGoal(this, Dolphin.class, true, true));
      ...
      this.goalSelector.addGoal(27, new RandomSwimmingGoal(this, 1.0, 40));
      this.goalSelector.addGoal(28, new AvoidEntityGoal(this, WaterAnimal.class, 512.0F, 1.0, 1.2));
      this.goalSelector.addGoal(30, new LookAtPlayerGoal(this, MegalodonEntity.class, 6.0F));
      this.goalSelector.addGoal(31, new LookAtPlayerGoal(this, BaskingSharkEntity.class, 6.0F));
      this.goalSelector.addGoal(32, new LookAtPlayerGoal(this, ShrakEntity.class, 6.0F));
      this.goalSelector.addGoal(33, new LookAtPlayerGoal(this, TigerSharkEntity.class, 6.0F));
      this.goalSelector.addGoal(34, new LookAtPlayerGoal(this, MakoSharkEntity.class, 6.0F));
      this.goalSelector.addGoal(35, new LookAtPlayerGoal(this, BlueSharkEntity.class, 6.0F));
      this.goalSelector.addGoal(36, new LookAtPlayerGoal(this, NurseSharkEntity.class, 6.0F));
      this.goalSelector.addGoal(37, new LookAtPlayerGoal(this, Turtle.class, 6.0F));
      this.goalSelector.addGoal(38, new LookAtPlayerGoal(this, Dolphin.class, 6.0F));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      CookiecutterSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BenssharksModEntities.COOKIECUTTER_SHARK.get(),
         SpawnPlacementTypes.IN_WATER,
         Types.MOTION_BLOCKING_NO_LEAVES,
         (entityType, world, reason, pos, random) -> world.getFluidState(pos.below()).is(FluidTags.WATER)
