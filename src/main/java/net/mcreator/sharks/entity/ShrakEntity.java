...
public class ShrakEntity extends PathfinderMob implements GeoEntity {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            if (ShrakEntity.this.isInWater()) {
               ShrakEntity.this.setDeltaMovement(ShrakEntity.this.getDeltaMovement().add(0.0, 0.005, 0.0));
            }

            if (this.operation == Operation.MOVE_TO && !ShrakEntity.this.getNavigation().isDone()) {
               ...
               ShrakEntity.this.setYRot(this.rotlerp(ShrakEntity.this.getYRot(), f, 10.0F));
               ...
               if (ShrakEntity.this.isInWater()) {
                  ...
                  ShrakEntity.this.setXRot(this.rotlerp(ShrakEntity.this.getXRot(), f2, 5.0F));
               ...
               ShrakEntity.this.setSpeed(0.0F);
               ShrakEntity.this.setYya(0.0F);
               ShrakEntity.this.setZza(0.0F);
            }
         }
      };
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "greatwhite");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
         e -> e.getType().is(DwurdySharksEntityTypeTags.GREATWHITESHARK_PREY)));
      this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, Player.class, true, true) {
         public boolean canUse() {
            return super.canUse() && AggressiveSharksProcedureProcedure.execute(ShrakEntity.this.level());
         }

         public boolean canContinueToUse() {
            return super.canContinueToUse() && AggressiveSharksProcedureProcedure.execute(ShrakEntity.this.level());
         }
      });
      this.goalSelector.addGoal(12, new LookAtPlayerGoal(this, WaterAnimal.class, 128.0F));
      this.goalSelector.addGoal(13, new AvoidEntityGoal(this, MegalodonEntity.class, 32.0F, 16.0, 16.0));
      this.goalSelector.addGoal(14, new AvoidEntityGoal(this, Dolphin.class, 32.0F, 16.0, 16.0));
      this.goalSelector.addGoal(15, new AvoidEntityGoal(this, TigerSharkEntity.class, 4.0F, 16.0, 16.0));
      this.goalSelector.addGoal(16, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(17, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(18, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      ShrakRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)DwurdySharksModEntities.GREATWHITESHARK.get(),
