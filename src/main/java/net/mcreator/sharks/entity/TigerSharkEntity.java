...
public class TigerSharkEntity extends PathfinderMob implements GeoEntity {
   ...
   public TigerSharkEntity(EntityType<TigerSharkEntity> type, Level world) {
      ...
      this.moveControl = new MoveControl(this) {
         public void tick() {
            ...
            if (this.operation == Operation.MOVE_TO && !TigerSharkEntity.this.getNavigation().isDone()) {
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "tigershark");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, true,
         e -> e.getType().is(DwurdySharksEntityTypeTags.TIGER_SHARK_PREY)));
      ...
      this.goalSelector.addGoal(15, new TemptGoal(this, 1.0, Ingredient.of(new ItemLike[]{(ItemLike)DwurdySharksModItems.FISH_BUCKET.get()}), false));
      this.goalSelector.addGoal(16, new TemptGoal(this, 1.0, Ingredient.of(new ItemLike[]{Items.COD}), false));
      this.goalSelector.addGoal(17, new TemptGoal(this, 1.0, Ingredient.of(new ItemLike[]{Items.SALMON}), false));
      ...
      this.goalSelector.addGoal(20, new AvoidEntityGoal(this, Dolphin.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(21, new AvoidEntityGoal(this, RemoraEntity.class, 16.0F, 16.0, 16.0));
      this.goalSelector.addGoal(22, new AvoidEntityGoal(this, WaterAnimal.class, 32.0F, 1.0, 1.0));
      this.goalSelector.addGoal(23, new RandomSwimmingGoal(this, 1.0, 40));
   }
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      TigerSharkRightClickedOnEntityProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public EntityDimensions getDefaultDimensions(Pose pose) {
      return super.getDefaultDimensions(pose).scale(1.75F);
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)DwurdySharksModEntities.TIGER_SHARK.get(),
   ...
   public static net.minecraft.world.entity.ai.attributes.AttributeSupplier.Builder createAttributes() {
      ...
      return builder.add(NeoForgeMod.SWIM_SPEED, 1.15);
   }
