...
public class ModelJaggedArmorJava<T extends Entity> extends EntityModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Head = armorHead.addOrReplaceChild(
         "Head",
      ...
      PartDefinition Body = armorBody.addOrReplaceChild(
         "Body",
         CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(1.01F)),
         PartPose.offset(0.0F, 0.0F, 0.0F)
      );
      PartDefinition Mohawk_r1 = Body.addOrReplaceChild(
         "Mohawk_r1",
         CubeListBuilder.create().texOffs(24, -13).addBox(0.0F, -6.0F, -25.0F, 0.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition LeftArm = armorLeftArm.addOrReplaceChild(
         "LeftArm",
      ...
      PartDefinition RightArm = armorRightArm.addOrReplaceChild(
         "RightArm",
      ...
      PartDefinition LeftLeg = armorLeftLeg.addOrReplaceChild(
         "LeftLeg",
         CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)).mirror(false),
      ...
      PartDefinition LeftBoot = armorLeftBoot.addOrReplaceChild(
         "LeftBoot",
         CubeListBuilder.create().texOffs(48, 0).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(1.0F)).mirror(false),
      ...
      PartDefinition RightLeg = armorRightLeg.addOrReplaceChild(
         "RightLeg",
         CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)),
         PartPose.offset(-3.9F, -1.0F, 0.0F)
      );
      ...
      PartDefinition RightBoot = armorRightBoot.addOrReplaceChild(
         "RightBoot",
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
      this.bipedHead.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
