   ...
   private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BenssharksModItems.SPETUM.get()) {
            if (entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(BenssharksModMobEffects.BLEEDING)) {
               if (entity instanceof LivingEntity _livEnt4 && _livEnt4.hasEffect(BenssharksModMobEffects.BLEEDING)) {
               ...
               _entity.addEffect(new MobEffectInstance(BenssharksModMobEffects.BLEEDING, 240, 0, true, false));
            }
         }
      }
   }
